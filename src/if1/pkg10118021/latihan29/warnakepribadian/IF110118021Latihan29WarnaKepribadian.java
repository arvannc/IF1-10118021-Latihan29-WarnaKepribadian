 ...
 */
package if1.pkg10118021.latihan29.warnakepribadian;
 ...
 */
public class IF110118021Latihan29WarnaKepribadian {
    ...
    public static void warnaMerah(){
        ...
        System.out.println("6. Dapat menahan marah namun jika sudah tahap puncak"
                + " toleransi, kemarahnnya akan sulit dikontrol,");
    ...
    public static void warnaUngu(){
        ...
        System.out.println("6. Memiliki sisi misterius sebab seringkali menutupi "
                + "perasaannya,");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(merah + " YUK " + hijau + "CEK " + kuning + 
                "KEPRIBADIANMU" +biruMuda + " DARI " + ungu + "WARNA " + biru + 
                "FAVORITMU\n\n");
        ...
        switch(cekWarna){
           case "MERAH" :
                 System.out.println(reset + "WARNA FAVORITMU ADALAH " + merah + 
                         cekWarna); warnaMerah();
                 break;
           case "HIJAU" :
                  System.out.println(reset + "WARNA FAVORITMU ADALAH " + hijau + 
                          cekWarna); warnaHijau();
                  break;
           case "KUNING" :
                   System.out.println(reset + "WARNA FAVORITMU ADALAH " + kuning + 
                           cekWarna); warnaKuning();
                   break;
           case "BIRU" :
                   System.out.println(reset + "WARNA FAVORITMU ADALAH " + biru + 
                           cekWarna); warnaBiru();
                   break;
           case "UNGU" :
                  System.out.println(reset + "WARNA FAVORITMU ADALAH " + ungu + 
                          cekWarna); warnaUngu();
                  break;
           default :
